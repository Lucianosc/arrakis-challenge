...
// ======= Arrakis Contracts Configuration =======
export const ARRAKIS_CONTRACTS: Record<string, Contract> = {
  vault: {
    address: "0x4ca9fb1f302b6bd8421bad9debd22198eb6ab723",
    abi: VAULT_ABI,
  },
  helper: {
  ...
  resolver: {
    address: "0x535c5fdf31477f799366df6e4899a12a801cc7b8",
    abi: RESOLVER_ABI,
  },
} as const;
